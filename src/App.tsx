...
export default function App() {
  ...
  return (
    <>
      {destino === 'hoy' && (
        <Hoy datos={datos} ahora={ahora} sesionEnCurso={sesionEnCurso} onEmpezar={empezar} onSeguir={() => setEnSesion(true)} onDescartar={async () => { if (sesionEnCurso) await datos.borrarSesion(sesionEnCurso.id); setActiva(null) }} onAjustes={() => setAjustes(true)} />
      )}
