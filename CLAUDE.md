...
App personal de rutina de gym para un solo usuario. Toda la especificación está en `BRIEF.md`, incluyendo la identidad visual en el Anexo A. `BRIEF.md` manda sobre cualquier suposición tuya. Para todo lo visual (color, tipografía, componentes, movimiento) manda `fm-assets/DISENO-FM-v3.md` (los mockups en `fm-assets/referencia/` son el objetivo visual); léelo antes de tocar cualquier pantalla. Si algo no está en el brief, pregunta antes de inventarlo.
