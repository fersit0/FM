...
App personal de rutina de gym para un solo usuario. Toda la especificación está en `BRIEF.md`, incluyendo la identidad visual en el Anexo A. `BRIEF.md` manda sobre cualquier suposición tuya. Si algo no está en el brief, pregunta antes de inventarlo.
